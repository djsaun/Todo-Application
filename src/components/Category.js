...
const Category = props => {
  const { id, title, todos, categories, deleteTodo, completeTodo } = props;
  ...
  return (
    <CategoryItem>
      ...
      {todos && todos.map(todo => <Todo key={todo.id} {...todo} deleteTodo={deleteTodo} completeTodo={completeTodo} categories={categories} />)}
    </CategoryItem>
  )
}
